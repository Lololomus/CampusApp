...
import {
  X, Bell, BellOff, Heart, MessageCircle, Package,
  HelpCircle, TrendingUp, BarChart3, ChevronRight, Info,
} from 'lucide-react';
                  ...
                  <div style={styles.frequencyRow}>
                    ...
                    <div style={styles.frequencyButtons}>
                      <button
                        style={{
                          ...styles.freqBtn,
                          ...(settings.digest_frequency === 'daily' ? styles.freqBtnActive : {}),
                        }}
                      ...
                      <button
                        style={{
                          ...styles.freqBtn,
                          ...(settings.digest_frequency === 'weekly' ? styles.freqBtnActive : {}),
                        }}
